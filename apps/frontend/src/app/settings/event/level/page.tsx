            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="form-subtitle">
                  Event levels specify the difficulty or complexity of the event. For example,
                  beginner, advanced, or expert. You can add new event levels, edit existing ones,
                  or delete them.
                </p>
              </div>
              ...
              {/* Add New Event Level */}
              <div className="">
                <h2 className="form-input-label mb-4">Add New Event Level</h2>
