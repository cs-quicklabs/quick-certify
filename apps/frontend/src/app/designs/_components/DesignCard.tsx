    ...
    <div className="flex items-center justify-between px-6 bg-white py-5 border-b border-gray-200 rounded shadow ">
      ...
      <div className="flex justify-end gap-2 text-sm font-medium">
        <Link
          ...
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M2.5 12S6.5 5 12 5s9.5 7 9.5 7-4 7-9.5 7-9.5-7-9.5-7z"></path></svg>
          <span>Preview</span>
        </Link>
        ...
        <Link
          ...
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M16.5 3.5l4 4L7 21H3v-4L16.5 3.5z"></path></svg>
          <span>Edit</span>
        </Link>

        <button className="px-3 py-1 flex gap-2 items-ccenter text-red-600 bg-red-50 rounded hover:bg-red-50">
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M6 7h12M9 7V4h6v3M10 11v6M14 11v6M5 7l1 13h12l1-13"></path></svg>
          <span>Delete</span>
        </button>
      </div>
    </div>
