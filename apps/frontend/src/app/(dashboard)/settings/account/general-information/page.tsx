...
export default function GeneralInformationPage() {
  ...
  const renderStatusAlerts = () => {
    ...
    if (settings.issuer_verified) {
      return (
        <div
          className="flex items-center p-2.5 mb-4 text-sm text-green-800 border border-green-300 rounded-sm bg-green-50"
          role="alert"
        >
          <svg
    ...
    return (
      <div
        className="flex items-center p-2.5 mb-4 text-sm text-yellow-800 border border-yellow-300 rounded-sm bg-yellow-50"
        role="alert"
      >
        <svg
