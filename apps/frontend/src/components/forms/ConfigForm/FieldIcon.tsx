...
export function FieldIcon({ icon }: FieldIconProps) {
  ...
  const wrapperClass =
    'inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 border rounded-e-0 border-gray-300 border-e-0 rounded-s-sm dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600';
