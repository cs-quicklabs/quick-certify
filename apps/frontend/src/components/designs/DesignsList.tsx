    ...
    <>
      ...
      <div className="flex justify-between mb-6 ">
        <div className="flex items-center gap-6 text-sm">
          <span className="text-gray-700 font-medium">Show records only for:</span>
      ...
      <div className="hidden sm:grid grid-cols-[1fr_auto] my-4 bg-gray-50 border-b border-gray-200">
        <span className="text-sm font-semibold text-gray-600 uppercase">Design</span>
        <span className="text-sm font-semibold text-gray-600 uppercase text-right">Actions</span>
      </div>
