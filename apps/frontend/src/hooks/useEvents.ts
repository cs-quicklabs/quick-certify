...
export const EVENT_TYPE_KEYS = {
    ...
    list: (filters?: { page?: number; limit?: number }) => [...EVENT_TYPE_KEYS.lists(), { filters }] as const,
...
export const EVENT_LEVEL_KEYS = {
    ...
    list: (filters?: { page?: number; limit?: number }) => [...EVENT_LEVEL_KEYS.lists(), { filters }] as const,
...
export const EVENT_FORMAT_KEYS = {
    ...
    list: (filters?: { page?: number; limit?: number }) => [...EVENT_FORMAT_KEYS.lists(), { filters }] as const,
...
export function useEventTypesInfinite() {
    return useInfiniteQuery({
        ...
        queryFn: ({ pageParam = 1 }) =>
            eventService.getEventTypes({ page: pageParam, limit: 20 }),
